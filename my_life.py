...
class Space:
    ...
    def clear_pre_verse(self, str_count):
        ...
        # Для windows у меня не получилось сделать адекватную анимацию, из-за несовместимы командной строки со спец символами
        # поэтому там идет просто очищение командной строки для каждого поколения
